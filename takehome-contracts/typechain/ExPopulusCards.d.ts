...
interface ExPopulusCardsInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getCardDetails(uint256)": FunctionFragment;
    "idCoutner()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getCardDetails",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(functionFragment: "idCoutner", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "idCoutner", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "isApprovedForAll",
    data: BytesLike
  ): Result;
...
export class ExPopulusCards extends BaseContract {
  ...
  functions: {
    ...
    idCoutner(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    idCoutner(overrides?: CallOverrides): Promise<PopulatedTransaction>;
